...
* `ssecurity login role create -role SVM_role_name -cmddirname "snapmirror list-destinations"-vserver SVM_name -access all`
* `ssecurity login role create -role SVM_role_name -cmddirname "event generate-autosupport-log"-vserver SVM_name -access all`
