...
有关故障排除信息、请参见 https://kb.netapp.com/mgmt/SnapCenter/SnapCenter_MFA_login_error_The_SAML_message_response_1_doesnt_match_the_expected_response_2["多个选项卡中的SnapCenter登录显示MFA错误"]
