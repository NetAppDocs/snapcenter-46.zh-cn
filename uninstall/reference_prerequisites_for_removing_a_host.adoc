...
有关卸载 SnapCenter Plug-in for VMware vSphere 的信息，请参见 https://docs.netapp.com/us-en/sc-plugin-vmware-vsphere/scpivs44_remove_plugin.html["删除适用于 VMware vSphere 的 SnapCenter 插件"^]。
